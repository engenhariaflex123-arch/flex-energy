...
const Topbar: React.FC<Props> = ({ period, setPeriod, onToggleSidebar }) => {
  ...
  return (
    <div className="app-topbar" style={{ background:'#181C27', borderBottom:'1px solid rgba(255,255,255,0.07)', padding:'0.875rem 1.5rem', display:'flex', alignItems:'center', justifyContent:'space-between', position:'sticky', top:0, zIndex:50 }}>
      <div style={{ display:'flex', alignItems:'center', gap:12 }}>
        ...
        <div>
          <div className="app-topbar-title" style={{ fontSize:15, fontWeight:600 }}>Dashboard — Visão Geral</div>
